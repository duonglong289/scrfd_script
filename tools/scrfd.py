...
class SCRFD:
    ...
    def forward(self, img, thresh):
        ...
        # len(net_outs) = 6
        # net_outs[0].shape = (1, 12800, 1)     # Score 8
        # net_outs[1].shape = (1, 3200, 1)      # Score 16
        # net_outs[2].shape = (1, 800, 1)       # Score 32
        # net_outs[3].shape = (1, 12800, 4)     # Bbox 8
        # net_outs[4].shape = (1, 3200, 4)      # Bbox 16
        # net_outs[5].shape = (1, 800, 4)       # Bbox 32
        # net_outs[6].shape = (1, 12800, 10)       # Bbox 32
        # net_outs[7].shape = (1, 3200, 10)       # Bbox 32
        # net_outs[8].shape = (1, 800, 10)       # Bbox 32
...
if __name__ == '__main__':
    ...
    detector = SCRFD(model_file='/mnt/ssd/genos/Github/insightface/detection/scrfd/onnx/scrfd_10g_bnkps.onnx')
    detector.prepare(-1)
    # img_paths = ['tests/data/t3.jpg']
    img_paths = ['/mnt/ssd/genos/Github/insightface/python-package/insightface/data/images/t1.jpg']
