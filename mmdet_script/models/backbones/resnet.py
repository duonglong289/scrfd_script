...
class ResNetV1e(ResNet):
    ...
    def __init__(self, 
            ...
            with_cp=False, 
            zero_init_residual=True):
        # super().__init__(depth, in_channels, stem_channels, base_channels, num_stages, block_cfg, strides, dilations, out_indices, style, deep_stem, avg_down, no_pool33, frozen_stages, conv_cfg, norm_cfg, norm_eval, dcn, stage_with_dcn, plugins, with_cp, zero_init_residual)
